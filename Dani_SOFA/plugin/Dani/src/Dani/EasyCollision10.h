...
class EasyCollision10 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision10, sofa::core::collision::ContactListener);
    EasyCollision10();
    virtual ~EasyCollision10() override;
...
protected:
    ...
    EasyCollision10(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
