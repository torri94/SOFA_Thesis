...
class EasyCollision11 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision11, sofa::core::collision::ContactListener);
    EasyCollision11();
    virtual ~EasyCollision11() override;
...
protected:
    ...
    EasyCollision11(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
