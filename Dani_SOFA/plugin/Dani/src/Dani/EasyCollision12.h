...
class EasyCollision12 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision12, sofa::core::collision::ContactListener);
    EasyCollision12();
    virtual ~EasyCollision12() override;
...
protected:
    ...
    EasyCollision12(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
