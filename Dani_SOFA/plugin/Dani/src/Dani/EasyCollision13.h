...
class EasyCollision13 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision13, sofa::core::collision::ContactListener);
    EasyCollision13();
    virtual ~EasyCollision13() override;
...
protected:
    ...
    EasyCollision13(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
