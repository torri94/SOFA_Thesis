...
class EasyCollision14 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision14, sofa::core::collision::ContactListener);
    EasyCollision14();
    virtual ~EasyCollision14() override;
...
protected:
    ...
    EasyCollision14(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
