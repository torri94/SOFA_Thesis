...
class EasyCollision15 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision15, sofa::core::collision::ContactListener);
    EasyCollision15();
    virtual ~EasyCollision15() override;
...
protected:
    ...
    EasyCollision15(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
