...
class EasyCollision16 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision16, sofa::core::collision::ContactListener);
    EasyCollision16();
    virtual ~EasyCollision16() override;
...
protected:
    ...
    EasyCollision16(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
