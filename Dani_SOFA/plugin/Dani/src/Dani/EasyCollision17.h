...
class EasyCollision17 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision17, sofa::core::collision::ContactListener);
    EasyCollision17();
    virtual ~EasyCollision17() override;
...
protected:
    ...
    EasyCollision17(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
