...
class EasyCollision18 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision18, sofa::core::collision::ContactListener);
    EasyCollision18();
    virtual ~EasyCollision18() override;
...
protected:
    ...
    EasyCollision18(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
