...
class EasyCollision19 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision19, sofa::core::collision::ContactListener);
    EasyCollision19();
    virtual ~EasyCollision19() override;
...
protected:
    ...
    EasyCollision19(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
