...
class EasyCollision20 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision20, sofa::core::collision::ContactListener);
    EasyCollision20();
    virtual ~EasyCollision20() override;
...
protected:
    ...
    EasyCollision20(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
