...
class EasyCollision22 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision22, sofa::core::collision::ContactListener);
    EasyCollision22();
    virtual ~EasyCollision22() override;
...
protected:
    ...
    EasyCollision22(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
