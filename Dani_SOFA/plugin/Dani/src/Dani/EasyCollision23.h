...
class EasyCollision23 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision23, sofa::core::collision::ContactListener);
    EasyCollision23();
    virtual ~EasyCollision23() override;
...
protected:
    ...
    EasyCollision23(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
