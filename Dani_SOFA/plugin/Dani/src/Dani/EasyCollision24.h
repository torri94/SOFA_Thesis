...
class EasyCollision24 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision24, sofa::core::collision::ContactListener);
    EasyCollision24();
    virtual ~EasyCollision24() override;
...
protected:
    ...
    EasyCollision24(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
