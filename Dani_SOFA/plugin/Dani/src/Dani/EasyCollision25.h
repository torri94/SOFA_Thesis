...
class EasyCollision25 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision25, sofa::core::collision::ContactListener);
    EasyCollision25();
    virtual ~EasyCollision25() override;
...
protected:
    ...
    EasyCollision25(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
