...
class EasyCollision26 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision26, sofa::core::collision::ContactListener);
    EasyCollision26();
    virtual ~EasyCollision26() override;
...
protected:
    ...
    EasyCollision26(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
