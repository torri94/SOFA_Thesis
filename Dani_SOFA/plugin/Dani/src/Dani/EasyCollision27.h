...
class EasyCollision27 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision27, sofa::core::collision::ContactListener);
    EasyCollision27();
    virtual ~EasyCollision27() override;
...
protected:
    ...
    EasyCollision27(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
