...
class EasyCollision28 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision28, sofa::core::collision::ContactListener);
    EasyCollision28();
    virtual ~EasyCollision28() override;
...
protected:
    ...
    EasyCollision28(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
