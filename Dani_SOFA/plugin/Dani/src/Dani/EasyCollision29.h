...
class EasyCollision29 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision29, sofa::core::collision::ContactListener);
    EasyCollision29();
    virtual ~EasyCollision29() override;
...
protected:
    ...
    EasyCollision29(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
