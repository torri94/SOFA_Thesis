...
class EasyCollision30 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision30, sofa::core::collision::ContactListener);
    EasyCollision30();
    virtual ~EasyCollision30() override;
...
protected:
    ...
    EasyCollision30(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
