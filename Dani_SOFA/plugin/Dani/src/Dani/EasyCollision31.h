...
class EasyCollision31 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision31, sofa::core::collision::ContactListener);
    EasyCollision31();
    virtual ~EasyCollision31() override;
...
protected:
    ...
    EasyCollision31(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
