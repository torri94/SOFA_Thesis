...
class EasyCollision32 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision32, sofa::core::collision::ContactListener);
    EasyCollision32();
    virtual ~EasyCollision32() override;
...
protected:
    ...
    EasyCollision32(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
