...
class EasyCollision33 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision33, sofa::core::collision::ContactListener);
    EasyCollision33();
    virtual ~EasyCollision33() override;
...
protected:
    ...
    EasyCollision33(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
