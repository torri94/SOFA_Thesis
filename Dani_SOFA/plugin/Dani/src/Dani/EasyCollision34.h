...
class EasyCollision34 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision34, sofa::core::collision::ContactListener);
    EasyCollision34();
    virtual ~EasyCollision34() override;
...
protected:
    ...
    EasyCollision34(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
