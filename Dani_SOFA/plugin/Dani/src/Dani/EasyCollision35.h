...
class EasyCollision35 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision35, sofa::core::collision::ContactListener);
    EasyCollision35();
    virtual ~EasyCollision35() override;
...
protected:
    ...
    EasyCollision35(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
