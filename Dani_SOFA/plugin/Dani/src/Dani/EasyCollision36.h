...
class EasyCollision36 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision36, sofa::core::collision::ContactListener);
    EasyCollision36();
    virtual ~EasyCollision36() override;
...
protected:
    ...
    EasyCollision36(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
