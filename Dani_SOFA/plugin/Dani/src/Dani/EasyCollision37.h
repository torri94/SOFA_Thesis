...
class EasyCollision37 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision37, sofa::core::collision::ContactListener);
    EasyCollision37();
    virtual ~EasyCollision37() override;
...
protected:
    ...
    EasyCollision37(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
