...
class EasyCollision38 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision38, sofa::core::collision::ContactListener);
    EasyCollision38();
    virtual ~EasyCollision38() override;
...
protected:
    ...
    EasyCollision38(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
