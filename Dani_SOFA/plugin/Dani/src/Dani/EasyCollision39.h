...
class EasyCollision39 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision39, sofa::core::collision::ContactListener);
    EasyCollision39();
    virtual ~EasyCollision39() override;
...
protected:
    ...
    EasyCollision39(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
