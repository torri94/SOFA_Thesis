...
class EasyCollision4 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision4, sofa::core::collision::ContactListener);
    EasyCollision4();
    virtual ~EasyCollision4() override;
...
protected:
    ...
    EasyCollision4(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
