...
class EasyCollision40 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision40, sofa::core::collision::ContactListener);
    EasyCollision40();
    virtual ~EasyCollision40() override;
...
protected:
    ...
    EasyCollision40(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
