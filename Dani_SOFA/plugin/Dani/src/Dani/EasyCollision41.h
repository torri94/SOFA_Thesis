...
class EasyCollision41 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision41, sofa::core::collision::ContactListener);
    EasyCollision41();
    virtual ~EasyCollision41() override;
...
protected:
    ...
    EasyCollision41(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
