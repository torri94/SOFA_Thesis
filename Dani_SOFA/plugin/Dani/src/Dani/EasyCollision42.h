...
class EasyCollision42 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision42, sofa::core::collision::ContactListener);
    EasyCollision42();
    virtual ~EasyCollision42() override;
...
protected:
    ...
    EasyCollision42(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
