...
class EasyCollision43 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision43, sofa::core::collision::ContactListener);
    EasyCollision43();
    virtual ~EasyCollision43() override;
...
protected:
    ...
    EasyCollision43(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
