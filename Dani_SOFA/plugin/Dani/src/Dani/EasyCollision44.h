...
class EasyCollision44 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision44, sofa::core::collision::ContactListener);
    EasyCollision44();
    virtual ~EasyCollision44() override;
...
protected:
    ...
    EasyCollision44(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
