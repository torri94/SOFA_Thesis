...
class EasyCollision45 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision45, sofa::core::collision::ContactListener);
    EasyCollision45();
    virtual ~EasyCollision45() override;
...
protected:
    ...
    EasyCollision45(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
