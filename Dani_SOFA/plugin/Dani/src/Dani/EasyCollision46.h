...
class EasyCollision46 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision46, sofa::core::collision::ContactListener);
    EasyCollision46();
    virtual ~EasyCollision46() override;
...
protected:
    ...
    EasyCollision46(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
