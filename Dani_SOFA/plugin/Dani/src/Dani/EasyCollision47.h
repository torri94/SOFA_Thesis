...
class EasyCollision47 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision47, sofa::core::collision::ContactListener);
    EasyCollision47();
    virtual ~EasyCollision47() override;
...
protected:
    ...
    EasyCollision47(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
