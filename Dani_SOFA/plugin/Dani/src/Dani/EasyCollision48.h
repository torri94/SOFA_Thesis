...
class EasyCollision48 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision48, sofa::core::collision::ContactListener);
    EasyCollision48();
    virtual ~EasyCollision48() override;
...
protected:
    ...
    EasyCollision48(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
