...
class EasyCollision49 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision49, sofa::core::collision::ContactListener);
    EasyCollision49();
    virtual ~EasyCollision49() override;
...
protected:
    ...
    EasyCollision49(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
