...
class EasyCollision5 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision5, sofa::core::collision::ContactListener);
    EasyCollision5();
    virtual ~EasyCollision5() override;
...
protected:
    ...
    EasyCollision5(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
