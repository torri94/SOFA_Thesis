...
class EasyCollision50 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision50, sofa::core::collision::ContactListener);
    EasyCollision50();
    virtual ~EasyCollision50() override;
...
protected:
    ...
    EasyCollision50(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
