...
class EasyCollision6 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision6, sofa::core::collision::ContactListener);
    EasyCollision6();
    virtual ~EasyCollision6() override;
...
protected:
    ...
    EasyCollision6(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
