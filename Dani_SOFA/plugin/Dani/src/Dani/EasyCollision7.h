...
class EasyCollision7 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision7, sofa::core::collision::ContactListener);
    EasyCollision7();
    virtual ~EasyCollision7() override;
...
protected:
    ...
    EasyCollision7(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
