...
class EasyCollision8 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision8, sofa::core::collision::ContactListener);
    EasyCollision8();
    virtual ~EasyCollision8() override;
...
protected:
    ...
    EasyCollision8(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
