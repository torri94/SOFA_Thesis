...
class EasyCollision9 : public sofa::core::collision::ContactListener
...
public:
    ...
    SOFA_CLASS(EasyCollision9, sofa::core::collision::ContactListener);
    EasyCollision9();
    virtual ~EasyCollision9() override;
...
protected:
    ...
    EasyCollision9(sofa::core::CollisionModel* collModel1 = NULL, sofa::core::CollisionModel* collModel2 = NULL) : ContactListener(collModel1, collModel2) { }
